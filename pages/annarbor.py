...
dash.register_page(__name__, path='/annarbor', name='Ann Arbor')
...
layout = html.Div([
    ...
    html.Div(children=[
    dcc.Graph(id='bar-graph-annarbor',style={"margin-top": "20px", "margin-bottom": "40px"})]),
    ...
    html.Div(children=[
             ...
             dash_table.DataTable(data = table.to_dict("records"), 
                                  ...
                                  id='avg-table-annarbor'),
            ]), 
    
    html.Div(children=[dcc.Graph(id='time-of-day-annarbor', style={"margin-top": "-80px", "margin-bottom": "50px"})]),
    html.Div(children=[dcc.Graph(id='day-of-week-annarbor')]),
...
@callback(
    Output(component_id='bar-graph-annarbor', component_property='figure'),
...
@callback(
    Output(component_id='avg-table-annarbor', component_property='data'),
    Input(component_id='my-date-picker-range', component_property='start_date'),
    Input(component_id='my-date-picker-range', component_property='end_date'))
...
@callback(
    Output(component_id='time-of-day-annarbor', component_property='figure'),
    Input(component_id='data-dir-radio', component_property='value'),
    Input(component_id='my-date-picker-range', component_property='start_date'),
    Input(component_id='my-date-picker-range', component_property='end_date'))
...
@callback(
    Output(component_id='day-of-week-annarbor', component_property='figure'),
    Input(component_id='data-dir-radio', component_property='value'),
    Input(component_id='my-date-picker-range', component_property='start_date'),
    Input(component_id='my-date-picker-range', component_property='end_date'))
