...
layout = html.Div([
    ...
    html.Div(children=[
    dcc.Graph(id='bar-graph-aa',style={'margin-top': '20px', 'margin-bottom': '40px'})]),
    ...
    html.Div(children=[dcc.Graph(id='time-of-day-aa', style={'margin-top': '-80px', 'margin-bottom': '50px'})]),
    html.Div(children=[dcc.Graph(id='day-of-week-aa')]),
...
@callback(
    Output(component_id='bar-graph-aa', component_property='figure'),
...
@callback(
    Output(component_id='avg-table-aa', component_property='data'),
    Input(component_id='my-date-picker-range', component_property='start_date'),
    Input(component_id='my-date-picker-range', component_property='end_date'))
...
@callback(
    Output(component_id='time-of-day-aa', component_property='figure'),
    Input(component_id='data-dir-radio', component_property='value'),
    Input(component_id='my-date-picker-range', component_property='start_date'),
    Input(component_id='my-date-picker-range', component_property='end_date'))
...
@callback(
    Output(component_id='day-of-week-aa', component_property='figure'),
    Input(component_id='data-dir-radio', component_property='value'),
    Input(component_id='my-date-picker-range', component_property='start_date'),
    Input(component_id='my-date-picker-range', component_property='end_date'))
