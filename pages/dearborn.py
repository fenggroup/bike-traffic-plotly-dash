from dash import dash, Dash, dcc, html, Input, Output, dash_table, callback
import plotly.express as px
import pandas as pd
import numpy as np
import dash

dash.register_page(__name__, path='/dearborn', name='Dearborn')
...
df = pd.read_csv(path, names=["time", "in", "out"], skiprows=3)
...
min_date_allowed = "2022-06-15"   # the first full *day* of data collection in AA
